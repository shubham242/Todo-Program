...
let usage = `Usage :-\r
$ ./todo add "todo item"  # Add a new todo\r
$ ./todo ls               # Show remaining todos\r
$ ./todo del NUMBER       # Delete a todo\r
$ ./todo done NUMBER      # Complete a todo\r
$ ./todo help             # Show usage\r
...
test("list todos in reverse order (added latest first)", () => {
  ...
  let expected = `[3] find needle in the haystack\r
[2] water the plants\r
[1] the thing i need to do\r
`;
